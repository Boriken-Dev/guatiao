 ...
 *
 * GENERATED BY cbindgen. DO NOT EDIT BY HAND. Regenerate with:
 *   cbindgen --config crates/guatiao/cbindgen.toml --crate guatiao \
 *            --output crates/guatiao/include/guatiao.h
 * A test compares the committed file against a fresh render, so an edit
 * to the Rust that is not regenerated fails the build rather than
 * shipping a header describing a different ABI.
 *
 * ----------------------------------------------------------------------
 ...
 * the middle of this file and are exported by whichever artifact was
 * built with the `c-exports` feature.
 *
